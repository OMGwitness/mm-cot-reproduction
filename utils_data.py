...
def load_data_img(args):
    ...
    if args.img_type == "resnet":
        image_features = np.load('/mnt/cloud_disk/zgj/vision_features/resnet.npy')
        ...
        image_features = np.load('/mnt/cloud_disk/zgj/vision_features/clip.npy')
    elif args.img_type == "detr":
        image_features = np.load('/mnt/cloud_disk/zgj/vision_features/detr.npy')
    elif args.img_type == "vit":
        image_features = torch.load("/mnt/cloud_disk/zgj/vision_features/vit.pth")
    else:
        image_features = np.load('/mnt/cloud_disk/zgj/vision_features/detr.npy')
